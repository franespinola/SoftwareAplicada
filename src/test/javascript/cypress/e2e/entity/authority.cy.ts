...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '236f6350-9c46-46c5-9023-704d75738ee5' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('a1403de2-709b-4ea0-829f-316763792b5a');
      cy.get(`[data-cy="name"]`).should('have.value', 'a1403de2-709b-4ea0-829f-316763792b5a');
